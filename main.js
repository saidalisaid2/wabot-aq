...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai  i am saidali, @user!\nഗ്രൂപ്പിലേക്ക് സ്വാഗതം @subject\n\n@desc'
  conn.bye = 'ഇറങ്ങി പോയി🙈 @user!'
  conn.spromote = '@user ഇപ്പോൾ അഡ്‌മിൻ!'
  conn.sdemote = '@user ഇപ്പോൾ അഡ്മിൻ അല്ല!'
